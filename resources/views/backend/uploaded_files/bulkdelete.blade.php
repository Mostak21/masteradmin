...
<div class="card">
    ...
    <div class="card-body"><form action="{{ route('uploaded-files.bulkdestroy') }}" method="get">
	...
	<script type="text/javascript">
		...
		function copyUrl(e) {
		    ...
		    try {
			    ...
			    RIT.plugins.notify('success', 'Link copied to clipboard');
			} catch (err) {
			    RIT.plugins.notify('danger', 'Oops, unable to copy');
			}
		    $temp.remove();
		}
