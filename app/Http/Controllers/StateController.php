...
class StateController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        $states = $state_queries->orderBy('name', 'asc')->paginate(15);
        return view('backend.address.states.index', compact('states', 'sort_country', 'sort_state'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('backend.address.states.edit', compact('countries', 'state'));
    }
